...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 font-medium new w-full max-w-sm px-6 py-12 flex flex-col flex-grow">
        <motion.h1
        ...
        <div className="space-y-3 w-full mt-auto text-sm">
          ...
          >
            ...
            <span className="ml-4 tracking-widest text-gray-300" style={{ fontFamily: "'Orbitron', sans-serif" }}>
              WHATSAPP
            </span>
          </motion.a>
          ...
          >
            ...
            <span className={`ml-4 tracking-widest text-gray-300 ${isAnimating ? 'text-white' : ''}`} style={{ fontFamily: "'Orbitron', sans-serif" }}>
              {buttonText}
            </span>
          </motion.button>
        </div>
